package com.jandiFactoring.redJandi.common.paging.dto;

import org.apache.ibatis.type.Alias;

@Alias("SelectCriteria")
public class SelectCriteria implements java.io.Serializable  {
	...
	public SelectCriteria(int pageNo, int totalCount, int limit, int buttonAmount, int maxPage, int startPage,
			int endPage, int startRow, int endRow, String searchCondition, String searchValue, String sortValue) {
		super();
		this.pageNo = pageNo;
